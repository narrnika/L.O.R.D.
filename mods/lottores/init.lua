...
if minetest.setting_getbool("msg_loading_mods") then minetest.log("action", minetest.get_current_modname().." mod LOADED") endlocal SL = rawget(_G, "intllib") and intllib.Getter() or function(s) return s end
