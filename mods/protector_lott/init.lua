		...
		if owner ~= digger then 
			if onlyowner or not protector.is_member(meta, digger) then
				...
				elseif infolevel == 2 then
					...
					SL("This area is owned by").." " .. owner .. ".")
					minetest.chat_send_player(digger,
					SL("Protection located at:").." " .. minetest.pos_to_string(pos))
					if members ~= "" then
						minetest.chat_send_player(digger,
						SL("Members:").." ".. members .. ".")
					end
...
minetest.register_node("protector_lott:protect", {
	description = SL("Protection Block"),
	tiles = {
...
minetest.register_craft({
	output = "protector_lott:protect 4",
	recipe = {
